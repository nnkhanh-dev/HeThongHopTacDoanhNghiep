...
namespace HopTacDoanhNghiep.ViewModels.ViecLam
{
    public class ViecLamVM
    {
        ...
        public string DoanhNghiepLogo { get; set; }
        public DateTime CreatedAt { get; set; }
        public DateTime? UpdatedAt { get; set; }

        public ICollection<ViecLamVM> ViecLamLienQuan = new List<ViecLamVM>();
    }
}
